    ...
    return new Promise((resolve, reject) => {
        ...
        if (params.get('lang')){
            ...
            if (["tr","fr","ru","de","pl"].includes(lang)){
                window.location.href = `https://soulsp34r.github.io/phasmo-cheat-sheet-${lang}/`
            }
            else{
                console.log("Hey! That language is not yet officially supported by the Zero-Network. If you would like to help translate the website, find me (SeverelyZero) on the Zero-Network Discord:")
            }
        }
